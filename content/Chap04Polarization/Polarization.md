...
```{figure} Images/4_01_Dphi_000pi_f1_BW.png
:name: 4_01_Dphi_000pi_f1_BW
Linear polarization
```

```{figure} Images/4_02_Dphi_05pi_f1_BW.png
:name: 4_02_Dphi_05pi_f1_BW
Circular polarization
```

```{figure} Images/4_03_Dphi_025pi_f1_BW.png
...
```{figure} Images/4_2_Rotation_Polarization.png
...
```{figure} Images/4_04_Rotation_polarization.png
