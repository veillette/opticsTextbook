...
```{figure} ../Images/ex_5_1_sources.png
:name: fig:ex5_1
Sources Figure
```
...
```{figure} ../Images/ex_5_2_planar_film.png
:name: fig:ex5_2
...
```{figure} ../Images/ex_5_3_point_source_mirror_bw.png
:name: Fig:ex_5_3
...
```{figure} ../Images/extended_source_2pinhole.png
:name: extendedSource
