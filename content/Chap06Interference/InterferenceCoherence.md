...
```{figure} Images/Arago1.jpg
```
```{figure} Images/Arago2.jpg
```
```{figure} Images/Arago3.jpg
:name: Arago
...
```{figure} Images/5_01_Atom_Random_Emission.png
...
```{figure} Images/5_02_Temporal_Coherence.png
...
```{figure} Images/5_04_Spatial_Coherence.png
...
```{figure} Images/5_06_Coherence_Propagation.png
...
\end{align*}
```
```{figure} Images/5_07_Coherence_Propagation.png
...
```{figure} Images/5_08_Stellar_interferometry.png
...
```{figure} Images/5_09_Visibility.png
...
```{figure} Images/5_10_Lloyd_Mirror.png
...
```{figure} Images/5_11_Fabry_Perot.png
:name: Fig_FP1
...
```{figure} Images/5_12_Fabry_Perot.Resonance.png
:name: Fig_FP2
