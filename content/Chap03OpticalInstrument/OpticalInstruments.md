...
```{figure} Images/3_01_Camera_obscura.jpg
...
```{figure} Images/3_02_Reflex_camera.png
...
```{figure} Images/3_04_Lego_Depth.jpg
...
```{figure} Images/3_05_Three_Internal_chambers_of_the_Eye.png
...
```{figure} Images/3_06_Focus_in_an_eye_a.png
```
```{figure} Images/3_06b_Accomodation_eye.png
:name: Fig_3_06_Eye
...
```{figure} Images/3_07_Eye_correction.png
...
```{figure} Images/3_08_magnifier_gruffalo_small.png
...
```{figure} Images/3_09_Magnifier.png
...
```{figure} Images/3_10_EyePiece.png
...
```{figure} Images/3_11_Compound_Microscope.png
...
```{figure} Images/3_12_Kepler_Telescope.png
...
```{figure} Images/3_13_Rays_Telescope.png
