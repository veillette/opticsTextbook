...
```{figure} Images/7_01_Gas_Source_Collimation.png
...
```{figure} Images/7_02_Laser_Source_Collimation.png
...
```{figure} Images/7_03_Laser_Focus.png
...
```{figure} Images/7_04_Laser_Decay.png
...
```{figure} Images/7_05_Fabry_Perrot_resonance_mode.png
...
```{figure} Images/7_06_Laser_Spectra.png
...
```{figure} Images/7_07_Laser_2level.png
...
```{figure} Images/7_08_Laser_dNN.png
...
```{figure} Images/7_09_Laser_3level.png
...
```{figure} Images/7_10_laser_cavity.png
...
```{figure} Images/7_11_Laser_loss_a.png
...
```{figure} Images/7_12_Laser_extra_Cavity_b.png
...
```{figure} Images/7_13_Laser_cavity_mode.png
...
```{figure} Images/7_14_laser_spatial_modes.png
...
```{figure} Images/7_15_Spectra_Trans_Mode.png
...
```{figure} Images/7_16_Pumping_Meta.png
...
```{figure} Images/7_18_Pumping_Collision.png
...
```{figure} Images/7_19_VCSEL_a.png
:name: Fig_7_19_VCSEL
