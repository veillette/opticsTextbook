...
```{figure} Images/11_01_angle_definition.png
:name: Fig.alpha
...
```{figure} Images/11_02_concave_mirror.png
...
```{figure} Images/11_03_spherical_lens_simplified.png
...
```{figure} Images/11_04_real_image.png
...
```{figure} Images/11_05_positive_lens.png
...
```{figure} Images/11_06_negative_lens.png
...
```{figure} Images/11_07_two_thin_lenses_separated.png
...
```{figure} Images/11_08_two_thin_lenses_close.png
...
```{figure} Images/11_09_thick_lens_principle_plane.png
...
```{figure} Images/11_10_principle_planes.png
...
```{figure} Images/11_11_thick_lens_imaging.png
