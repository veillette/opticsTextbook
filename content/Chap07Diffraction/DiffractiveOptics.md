...
```{figure} Images/07_05_RemoveHigh.png
(a) Removing the high spatial frequencies

```
```{figure} Images/07_06_RemoveLow.png
...
```{figure} Images/07_07_RemoveAmp.png
...
```
```{figure} Images/07_08_RemovePhase.png
...
```{figure} Images/07_09_UncertaintyPrinciple.png
...
```
for integer $m$.
```{figure} Images/07_10_Fraunhofer_2_point_source_light.png
...
```{figure} Images/07_12_FresnelDiffraction_L_distance.png
...
```{figure} Images/07_13_MultipleSlits712.png
...
```{figure} Images/07_15_2Sources.png
...
```{figure} Images/07_19_AiryDisk_Color_220405.png
